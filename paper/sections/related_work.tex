...
\paragraph{Control benchmarks.}
CartPole is a standard control problem originating in classic reinforcement-learning work \citep{barto1983neuronlike} and popularized in modern benchmark tooling by OpenAI Gym \citep{brockman2016openai}. We use CartPole-v1 as a CPU-light external dynamics check, not as a claim of benchmark leadership. Its role is to ask whether the proxy/support/return split survives outside the synthetic one-dimensional microscope.
